        ...
        <div >
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    <span class="navbar-brand" href="#">Cập nhật đánh giá</span>
                </div>
            </nav>
        </div>
        <section>
            <div class="row">
                ...
                <div class="col-9" style="left: 30%; position: absolute; width: 60%; height: 50%;">
                    <div class="col-9" style="left: 5%; position: absolute; width: 80%; height: 50%;">
                        <form action="capnhatdanhgia.htm" modelAttribute="record" method="post">
                            <div style="margin-left: 200px; margin-right: 200px; width: 400px">
                                <div class="form-group">
                                    <label for="text">Mã đánh giá:</label>
                                    <input type="text" name="recordid"  class="form-control"  value="${record1.recordid}" readonly="${RO}" id="email">
                                </div>
                                <div class="form-group">
                                    <label for="text">Loại đánh giá:</label>
                                    <div>
                                        <select id="a" name="recordtype">
                                            <option value="0">Kỷ luật</option>
                                            <option value="1">Thành tích</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="text">Ngày đánh giá:</label>
                                    <input type="date" value="${record1.recorddate}" class="form-control" name="recorddate">
                                </div>
                                <div class="form-group">
                                    <label for="text">Lý do:</label>
                                    <input type="text"name="recordreason" value="${record1.recordreason}"  class="form-control" placeholder="Nhập lý do">
                                </div>
                                <div class="form-group">
                                    <label for="text">Mã nhân viên:</label>
                                    <input type="text" name="staffid"  value="${record1.staffid}"  class="form-control" placeholder="Nhập mã nhân viên">
                                </div>
                            </div>
...
<script>
    function getCombobox() {
        document.getElementById("a").value = "${valueR}"
    }
</script>
