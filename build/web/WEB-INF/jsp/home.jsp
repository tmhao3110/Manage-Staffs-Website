        ...
        <div >
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    <span class="navbar-brand" href="#">Top 10 nhân viên đạt thành tích</span>
                </div>
            </nav>
        </div>
        <section>
            <div class="row">
                ...
                <%
                    int count=0;
                %>
                <div class="col-9" style="left: 30%; position: absolute; width: 60%; height: 50%; text-align: center;">
                    <table class="table table-bordered" >
                        ...
                        <c:forEach var="top" items="${listTOP10}">
                            <tr>
                                <td><%=count+=1%></td>
                                <td>${top.staffname}</td>
                                <td><img src="images/${top.photo}" width="100px" height="100px"></td>
                                <td>${top.departid}</td>
                            </tr>
                        </c:forEach>
                    </table>
