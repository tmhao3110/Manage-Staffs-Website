        ...
        <div >
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    <span class="navbar-brand" href="#">Thêm nhân viên</span>
                </div>
            </nav>
        </div>
        <section>
            <div class="row">
                ...
                <div class="col-9" style="left: 30%; position: absolute; width: 60%; height: 50%;">
                    <div class="col-9" style="left: 5%; position: absolute; width: 80%; height: 50%;">
                        <form action="themnhanvien.htm" modelAttribute="staff" method="post" enctype="multipart/form-data">
                            <div style="margin-left: 200px; margin-right: 200px; width: 400px">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="staffname" class="form-control" placeholder="Nhập tên nhân viên">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="textarea" name="notes" class="form-control" placeholder="Nhập ghi chú">
                                </div>
                                <div class="form-group">
                                    <label for="text">Mã phòng ban:</label>
                                    <input type="text" name="departid" class="form-control" placeholder="Nhập mã phòng ban">
                                </div>
                                <div class="form-group">
